...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vmulpd %%zmm0, %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vmulpd %%zmm1, %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vmulpd %%zmm2, %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vmulpd %%zmm3, %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vmulpd %%zmm4, %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vmulpd %%zmm5, %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vmulpd %%zmm6, %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vmulpd %%zmm7, %%zmm7, %%zmm7" : : : "zmm7");
