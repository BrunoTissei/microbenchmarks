...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vpsllvd %%zmm0, %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vpsllvd %%zmm1, %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vpsllvd %%zmm2, %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vpsllvd %%zmm3, %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vpsllvd %%zmm4, %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vpsllvd %%zmm5, %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vpsllvd %%zmm6, %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vpsllvd %%zmm7, %%zmm7, %%zmm7" : : : "zmm7");
