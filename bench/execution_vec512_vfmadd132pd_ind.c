...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vfmadd132pd %%zmm0, %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vfmadd132pd %%zmm1, %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vfmadd132pd %%zmm2, %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vfmadd132pd %%zmm3, %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vfmadd132pd %%zmm4, %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vfmadd132pd %%zmm5, %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vfmadd132pd %%zmm6, %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vfmadd132pd %%zmm7, %%zmm7, %%zmm7" : : : "zmm7");
