...
int main (int argc, char *argv[]) {
    ...
    asm volatile("loop:");
        ...
        asm volatile("div %r8d");
        MIDDLE
        asm volatile("div %r9d");
        MIDDLE
        asm volatile("div %r10d");
        MIDDLE
        asm volatile("div %r11d");
        MIDDLE
        asm volatile("div %r12d");
        MIDDLE
        asm volatile("div %r13d");
        MIDDLE
        asm volatile("div %r14d");
        MIDDLE
        asm volatile("div %r15d");
