...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("pxor %%xmm0, %%xmm8" : : : "xmm0");
        asm volatile("pxor %%xmm1, %%xmm9" : : : "xmm1");
        asm volatile("pxor %%xmm2, %%xmm10" : : : "xmm2");
        asm volatile("pxor %%xmm3, %%xmm11" : : : "xmm3");
        asm volatile("pxor %%xmm4, %%xmm12" : : : "xmm4");
        asm volatile("pxor %%xmm5, %%xmm13" : : : "xmm5");
        asm volatile("pxor %%xmm6, %%xmm14" : : : "xmm6");
        asm volatile("pxor %%xmm7, %%xmm15" : : : "xmm7");
