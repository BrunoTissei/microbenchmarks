...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vrsqrt14ps %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vrsqrt14ps %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vrsqrt14ps %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vrsqrt14ps %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vrsqrt14ps %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vrsqrt14ps %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vrsqrt14ps %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vrsqrt14ps %%zmm7, %%zmm7" : : : "zmm7");
