...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vcvtsi2sd %0, %%xmm0, %%xmm0" : "=r" (count0) : : "xmm0");
        asm volatile("vcvtsi2sd %0, %%xmm1, %%xmm1" : "=r" (count1) : : "xmm1");
        asm volatile("vcvtsi2sd %0, %%xmm2, %%xmm2" : "=r" (count2) : : "xmm2");
        asm volatile("vcvtsi2sd %0, %%xmm3, %%xmm3" : "=r" (count3) : : "xmm3");
        asm volatile("vcvtsi2sd %0, %%xmm4, %%xmm4" : "=r" (count4) : : "xmm4");
        asm volatile("vcvtsi2sd %0, %%xmm5, %%xmm5" : "=r" (count5) : : "xmm5");
        asm volatile("vcvtsi2sd %0, %%xmm6, %%xmm6" : "=r" (count6) : : "xmm6");
        asm volatile("vcvtsi2sd %0, %%xmm7, %%xmm7" : "=r" (count7) : : "xmm7");
