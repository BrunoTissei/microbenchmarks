...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("sqrtsd %%xmm0, %%xmm0" : : : "xmm0");
        asm volatile("sqrtsd %%xmm1, %%xmm1" : : : "xmm1");
        asm volatile("sqrtsd %%xmm2, %%xmm2" : : : "xmm2");
        asm volatile("sqrtsd %%xmm3, %%xmm3" : : : "xmm3");
        asm volatile("sqrtsd %%xmm4, %%xmm4" : : : "xmm4");
        asm volatile("sqrtsd %%xmm5, %%xmm5" : : : "xmm5");
        asm volatile("sqrtsd %%xmm6, %%xmm6" : : : "xmm6");
        asm volatile("sqrtsd %%xmm7, %%xmm7" : : : "xmm7");
