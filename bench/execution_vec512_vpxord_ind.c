...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vpxord %%zmm8 , %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vpxord %%zmm9 , %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vpxord %%zmm10, %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vpxord %%zmm11, %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vpxord %%zmm12, %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vpxord %%zmm13, %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vpxord %%zmm14, %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vpxord %%zmm15, %%zmm7, %%zmm7" : : : "zmm7");
