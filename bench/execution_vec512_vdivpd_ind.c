...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vdivpd %%zmm0, %%zmm0, %%zmm0" : : : "zmm0");
        asm volatile("vdivpd %%zmm1, %%zmm1, %%zmm1" : : : "zmm1");
        asm volatile("vdivpd %%zmm2, %%zmm2, %%zmm2" : : : "zmm2");
        asm volatile("vdivpd %%zmm3, %%zmm3, %%zmm3" : : : "zmm3");
        asm volatile("vdivpd %%zmm4, %%zmm4, %%zmm4" : : : "zmm4");
        asm volatile("vdivpd %%zmm5, %%zmm5, %%zmm5" : : : "zmm5");
        asm volatile("vdivpd %%zmm6, %%zmm6, %%zmm6" : : : "zmm6");
        asm volatile("vdivpd %%zmm7, %%zmm7, %%zmm7" : : : "zmm7");
