...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("maxsd %%xmm0, %%xmm0" : : : "xmm0");
        asm volatile("maxsd %%xmm1, %%xmm1" : : : "xmm1");
        asm volatile("maxsd %%xmm2, %%xmm2" : : : "xmm2");
        asm volatile("maxsd %%xmm3, %%xmm3" : : : "xmm3");
        asm volatile("maxsd %%xmm4, %%xmm4" : : : "xmm4");
        asm volatile("maxsd %%xmm5, %%xmm5" : : : "xmm5");
        asm volatile("maxsd %%xmm6, %%xmm6" : : : "xmm6");
        asm volatile("maxsd %%xmm7, %%xmm7" : : : "xmm7");
