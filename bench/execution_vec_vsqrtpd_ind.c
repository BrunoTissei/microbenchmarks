...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("vsqrtpd %%xmm0, %%xmm0" : : : "xmm0");
        asm volatile("vsqrtpd %%xmm1, %%xmm1" : : : "xmm1");
        asm volatile("vsqrtpd %%xmm2, %%xmm2" : : : "xmm2");
        asm volatile("vsqrtpd %%xmm3, %%xmm3" : : : "xmm3");
        asm volatile("vsqrtpd %%xmm4, %%xmm4" : : : "xmm4");
        asm volatile("vsqrtpd %%xmm5, %%xmm5" : : : "xmm5");
        asm volatile("vsqrtpd %%xmm6, %%xmm6" : : : "xmm6");
        asm volatile("vsqrtpd %%xmm7, %%xmm7" : : : "xmm7");
