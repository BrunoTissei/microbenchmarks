...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("pslld %%xmm0, %%xmm0" : : : "xmm0");
        asm volatile("pslld %%xmm1, %%xmm1" : : : "xmm1");
        asm volatile("pslld %%xmm2, %%xmm2" : : : "xmm2");
        asm volatile("pslld %%xmm3, %%xmm3" : : : "xmm3");
        asm volatile("pslld %%xmm4, %%xmm4" : : : "xmm4");
        asm volatile("pslld %%xmm5, %%xmm5" : : : "xmm5");
        asm volatile("pslld %%xmm6, %%xmm6" : : : "xmm6");
        asm volatile("pslld %%xmm7, %%xmm7" : : : "xmm7");
