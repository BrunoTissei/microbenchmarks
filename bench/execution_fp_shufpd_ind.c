...
int main (int argc, char *argv[]) {
    ...
    for (i = 1; i <= repetitions; i++) {
        asm volatile("shufpd $2, %%xmm0, %%xmm0" : : : "xmm0");
        asm volatile("shufpd $2, %%xmm1, %%xmm1" : : : "xmm1");
        asm volatile("shufpd $2, %%xmm2, %%xmm2" : : : "xmm2");
        asm volatile("shufpd $2, %%xmm3, %%xmm3" : : : "xmm3");
        asm volatile("shufpd $2, %%xmm4, %%xmm4" : : : "xmm4");
        asm volatile("shufpd $2, %%xmm5, %%xmm5" : : : "xmm5");
        asm volatile("shufpd $2, %%xmm6, %%xmm6" : : : "xmm6");
        asm volatile("shufpd $2, %%xmm7, %%xmm7" : : : "xmm7");
